...
class Warehouse {
    ...
    fun productDescriptions(): String{
        var description = ""
    ...
    fun fillWarehouse(productName: String, basePrice: Double, productDescription: String,
        ...
        var product = Product(productName, basePrice, basePrice * (1+chargeOnTop/100), productDescription)
        var discountProduct = DiscountProduct(productName + "Discounted", basePrice, basePrice * (1+chargeOnTop/100), productDescription, DiscountType.SummerSale)
